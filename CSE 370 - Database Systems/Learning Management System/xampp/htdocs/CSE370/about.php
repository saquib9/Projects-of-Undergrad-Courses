        ...
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-7">
              ...
              <p>Some items may be waiting for approval</p>
            </div>
          </div>
        </div>
      </div> 
    ...
    <div class="site-section">
      ...
      <?php if($CAT=='F'){ ?>
       ...
       <div class="row">
                ...
                $sql = "SELECT * FROM `notes` WHERE `ACCEPTED`=0";
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="course-1-item">
                        ...
                        <h2><?php echo $row['LINK']; ?></h2>
                        
                        <p><a href="<?php echo $row['LINK']; ?>" class="btn btn-primary rounded-0 px-4">See Note</a></p>
                        <p><a href="approved1.php?ID=<?php echo $row['ID']; ?>" class="btn btn-primary rounded-0 px-4">Approve</a></p>
                        </div>
                    </div>
                </div>
                <?php } ?>
      ...
      <?php } elseif(($CAT=='A')){ ?>
            ...
            <div class="row">
                ...
                $sql = "SELECT * FROM `courses` WHERE `ACCEPTED`=0";
                $result = mysqli_query($conn, $sql);
                while($row = mysqli_fetch_array($result)){
                ?>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="course-1-item">
                        ...
                        <p><a href="approved2.php?ID=<?php echo $row['ID']; ?>" class="btn btn-primary rounded-0 px-4">Approve</a></p>
                        </div>
                    </div>
                </div>
                <?php } ?>
