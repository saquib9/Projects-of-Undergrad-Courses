    ...
    <div class="hero-slide owl-carousel site-blocks-cover">
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-12 mx-auto text-center" data-aos="fade-up">
              <h1>Notes Sharing To Enhance Exam Preparation</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="intro-section" style="background-image: url('images/hero_2.jpg');">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-12 mx-auto text-center" data-aos="fade-up">
              <h1> Keep Up With Your Courses</h1>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            ...
            <div class="feature-1 border">
              ...
              <div class="feature-1-content">
                <h2>Teachers' Hub</h2>
                <p>Helps teachers to keep up with courses </p>
          ...
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            <div class="feature-1 border">
              ...
              <div class="feature-1-content">
                <h2>Students' Track</h2>
                <p>Helps students to keep up with courses</p>
                <p><a href="#" class="btn btn-primary px-4 rounded-0">Learn More</a></p>
              </div>
            </div> 
          </div>
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            <div class="feature-1 border">
              ...
              <div class="feature-1-content">
                ...
                <p>Let's check out the materials</p>
                <p><a href="#" class="btn btn-primary px-4 rounded-0">Learn More</a></p>
              </div>
            </div> 
          </div>
              ...
              <div class="owl-slide-3 owl-carousel">
                  <div class="course-1-item">
                    <figure class="thumnail">
                      <a href="course-single.htmlx"><img src="images/course_1.jpg" alt="Image" class="img-fluid"></a>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-5 mb-lg-0">
            ...
            <a href="https://www.bracu.ac.bd"><h3>University Home</h3></a>
            <p></p>
          </div>
          <div class="col-lg-4 col-md-6 mb-5 mb-lg-0">
            <span class="icon flaticon-school-material"></span>
            <a href="https://www.bracu.ac.bd/academics"><h3>Academics</h3></a>
            <p></p>
          </div>
          <div class="col-lg-4 col-md-6 mb-5 mb-lg-0">
            <span class="icon flaticon-library"></span>
            <a href="https://www.bracu.ac.bd/news-events/news-archive"><h3>News and Notices</h3></a>
            <!--<p> </p>-->
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
         ...
         <!-- <div class="col-lg-3">
          ...
          <div class="col-lg-3">
              <h3 class="footer-heading"><span>Departments</span></h3>
              <ul class="list-unstyled">
                  <li><a href="https://www.bracu.ac.bd/academics/departments/architecture">Dept. of Architecture</a></li>
                  <li><a href="https://www.bracu.ac.bd/academics/institutes-and-schools/brac-business-school">BRACU Business School</a></li>
                  <li><a href="https://www.bracu.ac.bd/academics/departments/computer-science-and-engineering">Dept. of Computer Science and Engineering</a></li>
                  <li><a href="https://www.bracu.ac.bd/academics/departments/electrical-and-electronic-engineering">Dept. of Electrical and Electronics Engineering</a></li>
                  <li><a href="https://www.bracu.ac.bd/academics/departments/english-and-humanities">Dept. of English and Humanities</a></li>
                  <li><a href="https://www.bracu.ac.bd/academics/departments/economics-and-social-sciences">Dept. of Economics and Social-Sciences </a></li>
                  <li><a href="https://www.bracu.ac.bd/academics/departments/mathematics-and-natural-sciences">Dept. of Mathematics and Natural Sciences</a></li>
                  <li><a href="https://www.bracu.ac.bd/academics/departments/pharmacy">Dept. of Pharmacy</a></li>
