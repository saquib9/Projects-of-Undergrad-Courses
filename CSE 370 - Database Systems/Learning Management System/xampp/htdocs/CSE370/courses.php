...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
        <div class="container">
    <?php if($CAT=='A' || $CAT=='F') { ?>
    <p><a href="newCourse.php?id=<?php echo $_GET['id']; ?>" class="btn btn-primary rounded-0 px-4">Add Course</a></p>
    ...
    <?php } if($CAT=='A') { ?>
            ...
            <div class="row">
                ...
                $sql = "SELECT * FROM `courses` WHERE `dept`='$DID' and `accepted`=1";
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="course-1-item">
                        ...
                        <p><a href="course-single.php?id=<?php echo $row['ID']; ?>" class="btn btn-primary rounded-0 px-4">See More</a></p>
                            <p><a href="deleteCourse.php?id=<?php echo $row['ID']; ?>" class="btn btn-primary rounded-0 px-4">Delete</a></p>
                        </div>
                    </div>
                </div>
                <?php } ?>
