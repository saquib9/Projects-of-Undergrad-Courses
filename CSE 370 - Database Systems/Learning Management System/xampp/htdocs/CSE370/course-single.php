    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('images/bg_1.jpg')">
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-7">
              <h2 class="mb-0"><?php echo $response['NAME']; ?></h2>
    ...
    <div class="site-section">
        <div class="container">
            <div class="row">
                ...
                $sql = "SELECT * FROM `material` WHERE `CID`='$CID'";
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="course-1-item">
                        ...
                        <h2><?php echo $row['LINK'],4; ?></h2>
                        
                        
                        <p><a href="<?php echo $row['LINK']; ?>" class="btn btn-primary rounded-0 px-4">See Note</a></p>
                            <p><a download="<?php echo $row['LINK']; ?>" href="<?php echo $row['LINK']; ?>" class="btn btn-primary rounded-0 px-4">Download</a></p>
                        </div>
                    </div>
                </div>
                <?php } ?>
                ...
                <?php if($CAT=='F'){ ?>
                        ...
                        <form action="uplaodM.php?CID=<?php echo $CID; ?>" method="post" enctype="multipart/form-data">
                            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <input type="submit" name="register" value="Upload" class="btn btn-primary btn-lg px-5">
                        </div>
                    </div>
                    </form>
                ...
                $sql = "SELECT * FROM `notes` WHERE `accepted`=1 and `CID`='$CID'";
            ...
            <?php if($CAT=='S'){ ?>
                        ...
                        <form action="upload.php?CID=<?php echo $CID; ?>" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-12 form-group">
