  ...
  <div class="site-wrap">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="course-1-item">
                        ...
                        <p><a href="courses.php?id=<?php echo $row['ID']; ?>" class="btn btn-primary rounded-0 px-4">See More</a></p>
                        </div>
                    </div>
                </div>
                <?php } ?>
    ...
    <!--<div class="footer">
      <div class="container">
        <div class="row">
          <div class="col-lg-3">
            <p class="mb-4"><img src="images/logoF.png" alt="Image" class="img-fluid"></p>
